...
//  }
//
//  public void compute(Consumer<Ints> componentConsumer) {
...
//  }
//
//  private void strongConnect(int i, Consumer<Ints> componentConsumer) {
//
//    compIndices[i] = idx;
//    lowLinks[i] = idx;
//    idx++;
...
//      Ints comp = new ArrayInts(adj.indices.size());
//      int compSize = 0;
//      while (true) {
...
//  }
//
//  private void traverseNeighbors(final int row, Consumer<Ints> componentConsumer) {
...
//  }
//
//  private void update(int v, int w, Consumer<Ints> componentConsumer) {
//    if (compIndices[w] == -1) {
