...
@Deprecated
public class DeprecatedCompressedSparseGraphBuilder {
  ...
  public DeprecatedCompressedSparseGraphBuilder() {
  ...
  public DeprecatedCompressedSparseGraphBuilder add(int u, int v, double weight) {
    set(ptr++, u, v, weight);
  ...
  public CompressedSparseGraphDatastore build() {
    if (ptr == 0L) {
