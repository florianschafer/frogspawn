...
\begin{document}
    ...
    \lettrineabstract{
        NOTE: At this moment, this document is far from complete. It's only purpose right now is to retain
    ...
    However, the current landscape of available and ready-use clustering algorithms only partially contributes to this goal.
    While some established methods (such as PCA, t-SNE or LDA) stand on very solid theoretical grounds, none of them
    actually provide a proper explanation of the results that end users and decision makers might find reasonable.
