...
\begin{document}
    ...
    \begin{eigenvalueReplacement}
        ...
        Moreover, the eigenvector assigned with $\mu$ is the same as $v_i$.
        \begin{proof}[Proof]
    ...
    \begin{shifting}
        ...
        eigenvalue of the following matrix is exactly that of the second-smallest eigenvalue of the regular
